...
/**
 * System-Card Contents (page 03). Upper band: title block + colored TOC. Lower
 * band: the reading apparatus — who this is for, how to read it, at a glance,
 * a micro-glossary, and a five-waypoint reading path.
 */
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1.1fr", columnGap: "0.5in" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <div style={{ marginTop: 14 }}>
            ...
            <LabelValue label="Source" value={BRAND.repo} />
          </div>
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: 9 }}>
          <SmallLabel>System-Card Contents</SmallLabel>
      ...
      >
        <p
          style={{
            ...
            margin: 0,
            maxWidth: "4.4in",
            borderLeft: `2px solid ${COLORS.AMBER_DEEP}`,
            paddingLeft: 14,
          }}
        >
          {TOC.teaser}
