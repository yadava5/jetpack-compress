 ...
 * layout at an 840×1080 viewport — one leaf is exactly 8.75in × 11.25in =
 * 840×1080 CSS px there, so the scale computes to exactly 1 and the gate keeps
 * its full sensitivity. Scaling relative to the *spread* width instead would
 * put clipcheck at ~0.5 and silently halve every overflow threshold it checks.
 */
